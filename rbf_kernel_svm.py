...
# Initialize the SVM with a Radial Basis Function (RBF) kernel, wrapped in OneVsRestClassifier
...
# Display results
print(f'Accuracy of RBF SVM classifier (One-vs-Rest): {accuracy:.2f}')
